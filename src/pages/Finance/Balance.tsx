...
const Balance = () => {
  ...
  return (
    <div className="p-4">
      <h1 className="text-2xl font-bold mb-4 text-black">Số dư TK Shopii</h1>
      ...
      <div className="bg-white p-4 rounded shadow">
        ...
        <div className="flex items-center mb-4">
          ...
          <button
            onClick={() => setActiveCashFlow('all')}
            className={`px-4 py-2 relative bg-gray-100 ${activeCashFlow === 'all'
          ...
          <button
            onClick={() => setActiveCashFlow('in')}
            className={`px-4 py-2 relative bg-gray-100 ${activeCashFlow === 'in'
              ? "font-bold text-orange-500"
              : "text-gray-600 hover:text-orange-500"
              } mr-1`}
            style={{ outline: "none", border: "none" }}
          ...
          <button
            onClick={() => setActiveCashFlow('out')}
            className={`px-4 py-2 relative bg-gray-100 ${activeCashFlow === 'out'
              ? "font-bold text-orange-500"
              : "text-gray-600 hover:text-orange-500"
              }`}
            style={{ outline: "none", border: "none" }}
        ...
        <div className="flex items-center mb-4">
          ...
          <label className="border border-gray-300 px-2 py-1 rounded text-sm bg-white text-black hover:bg-gray-100 mr-1 flex items-center cursor-pointer">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center">
            ...
            <button className="border border-gray-300 bg-white px-2 py-1 rounded text-sm text-black hover:bg-gray-100">
              Xuất
            </button>
